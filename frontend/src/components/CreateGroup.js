...
const CreateGroup = () => {
    ...
    useEffect(() => {
        ...
        const fetchUsers = async () => {
            try {
                const response = await axios.get('https://api.greencoder.tech/api/auth/users/', {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const groupResponse = await axios.post('https://api.greencoder.tech/api/groups/', {
            ...
            if (groupResponse.data && groupResponse.data.id) {
                ...
                await axios.post(`https://api.greencoder.tech/api/groups/${groupId}/assign_users_to_group/`, {
